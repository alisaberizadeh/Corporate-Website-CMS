                ...
                <div class="col-lg-12">
                    <div class="breatcome_title">
                        ...
                        <div class="breatcome_content">
                            <ul>
                                <li><a href="/">Home</a><i class="fa fa-angle-left"></i><span>Products </span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="reply_ttl">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 mt-4">
                                            ...
                                            <div class="contact_from mr-20">
                                                <form action="{{ route('en.comment') }}" method="POST"> @csrf
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form_box mb-30">
                                                                <textarea name="text" required id="message" cols="30" rows="10" placeholder="Enter Message "></textarea>
                                                            </div>
