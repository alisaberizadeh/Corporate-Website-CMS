...
@include('includes.styles')
    ...
    @if ($slider == 1)
        ...
        <div class="slider_list owl-carousel">
            ...
            @foreach ($slider_ui as $slider_ui_item)
                <div class="slider_area d-flex align-items-center slider4"
                    style="background-image: url('{{ $slider_ui_item->image }}')">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                    ...
                                    <div class="slider_content color_black">
                                        <div class="slider_text">
                                            <div class="slider_text_inner">
                                                <h1 style="font-size: 45px">{!! $slider_ui_item->title !!}</h1>
                                            </div>
                                            <div class="slider_text_desc pt-4">
                                                <p>{!! $slider_ui_item->text !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="section_title text_center mb-5">
                            <div class="section_sub_title uppercase mb-3">
                                <h6>{{ $services_information->name_fa }}</h6>
                            </div>
                            <div class="section_main_title">
                                <h1>{{ $services_information->title }}</h1>
                            </div>
                            <div class="em_bar">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="service_style_three pt-60 pl-30 pr-30 mb-5 text_center">
                                ...
                                <div class="service_style_three_bt_icon pt-30">
                                    <a href="{{ route('services_single', $services_ui_item->id) }}"><i
    ...
    @if ($statistics == 1)
        <div class="counter_area white bg_before bg_fixed pt-280 pb-100 page_speed_736417182"
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="section_title text_left mb-60 mt-3">
                            <div class="section_sub_title uppercase mb-3">
                                <h6>{{ $random_product_information->name_fa }}</h6>
                            </div>
                            <div class="section_main_title">
                                <h1>{{ $random_product_information->title }}</h1>
                            </div>
                            <div class="em_bar">
                                <div class="em_bar_bg"></div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="section_title text_left mb-50 mt-3">
                            <div class="section_sub_title uppercase mb-3">
                                <h6>{{ $team_information->name_fa }}</h6>
                            </div>
                            <div class="section_main_title">
                                <h1>{{ $team_information->title }}</h1>
                            </div>
                            <div class="em_bar">
                                <div class="em_bar_bg"></div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section_title text_center mb-50 mt-3">
                            <div class="section_sub_title uppercase mb-3">
                                <h6>{{ $plans_information->name_fa }}</h6>
                            </div>
                            <div class="section_main_title">
                                <h1>{{ $plans_information->title }}</h1>
                            </div>
                            <div class="em_bar">
                                <div class="em_bar_bg"></div>
                            </div>
                                ...
                                <div class="single_pricing_content">
                                    <div class="single_pricing_content_inner">
                                        ...
                                        <div class="pricing_tk pt-3 pb-4">
                                            <h2>{{ number_format($plans_ui_item->price) }} <span>/
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="section_title text_left mb-60 mt-3">
                            <div class="section_sub_title uppercase mb-3">
                                <h6>{{ $blog_information->name_fa }}</h6>
                            </div>
                            <div class="section_main_title">
                                <h1>{{ $blog_information->title }}</h1>
                            </div>
                            <div class="em_bar">
                                <div class="em_bar_bg"></div>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="section_button mt-50">
                            <div class="button two text-left"><a href="/blog">نمایش همه مقالات</a></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    @foreach ($blog_ui as $blog_ui_item)
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="single_blog mb-4">
                                <div class="single_blog_thumb"><a
                                        href="{{ route('articles.single', $blog_ui_item->id) }}"><img
                                            src="{{ asset($blog_ui_item->image) }}"
                                            alt="{{ $blog_ui_item->name }}" /></a>
                                </div>
                                <div class="single_blog_content pt-4 pl-4 pr-4">
                                    <div class="techno_blog_meta"><a href="#">{{ $blog_ui_item->date_fa }}</div>
                                    <div class="blog_page_title pb-1">
                                        <h3><a
                                                href="{{ route('articles.single', $blog_ui_item->id) }}">{{ $blog_ui_item->name }}</a>
                                        </h3>
                                    </div>

                                    <div class="blog_page_button pb-4 mt-1"><a
                                            href="{{ route('articles.single', $blog_ui_item->id) }}">ادامه مطلب <i
                                                class="fa fa-long-arrow-left"></i></a></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
