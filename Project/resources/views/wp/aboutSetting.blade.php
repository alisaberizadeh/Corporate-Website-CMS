...
@section('content')
    <section class="content-header">
        ...
        <div class="row">
            ...
            @endif
            <form action="{{route('sections.about.update',$about->id)}}" method="POST" enctype="multipart/form-data"> @csrf @method('put')
                <div class="card card-primary mt-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12 row mb-5">
                            ...
                            <input type="text" name="name_fa" value="{{$about->name_fa}}" class="form-control " required>
                        </div> 
                        <div class="col-lg-12 row mb-5">
