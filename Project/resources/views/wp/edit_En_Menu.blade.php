    ...
    <section class="content-header">
        ...
        <div class="row">
            ...
            <div class="card card-primary p-0 mt-3 ml-4 col-lg-5" style="overflow: hidden">
                <form action="{{ route('menus.update.en', $menus->id) }}" method="POST" enctype="multipart/form-data"> @csrf @method('put')
                    <div class="card-header ">
                        <h3 class="card-title"> ویرایش آیتم  منو </h3>
                    </div>
            ...
            <div class="alert alert-info col-lg-6">
                ...
                <strong dir="ltr" class="text-left">
                    <ul>
                        ...
                        <li> en/about </li>
                        <li> en/blog </li>
                        <li> en/blog / (post_id) </li>
                        <li> en/products </li>
                        <li> en/product / (product_id) </li>
                        <li> en/services / (services_id) </li>
                    </ul>
                </strong>
            </div>
